...
function update() {
  ...
  var phase2 = Math.round((Date.parse("March 1, 2018"))/(1000*60*60*24));
  var phase3 = Math.round((Date.parse("June 1, 2018"))/(1000*60*60*24));
  var phase4 = Math.round((Date.parse("September 1, 2018"))/(1000*60*60*24));
  var end_d = Math.round((Date.parse("March 1, 2019"))/(1000*60*60*24));
